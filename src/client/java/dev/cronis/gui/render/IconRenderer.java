...
/**
 * Draws clean vector-style icons for the Cronis interface.
 * <p>
 * Icons are composed from axis-aligned fills so they remain crisp at every GUI scale.
 */
public final class IconRenderer {
	...
	/**
	 * Supported icon glyphs for header and input surfaces.
	 */
	public enum Icon {
		SETTINGS,
		DISCORD,
	...
	/**
	 * Draws an icon centered inside a square boundary.
	 *
	 * @param context the draw context
	 * @param icon    icon to draw
	 * @param x       boundary X position
	 * @param y       boundary Y position
	 * @param size    boundary width and height
	 * @param color   icon color in ARGB format
	 */
